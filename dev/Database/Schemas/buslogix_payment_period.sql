...
CREATE TABLE `payment_period` (
  ...
  KEY `fk_payment_period_request` (`company_id`,`request_id`),
  CONSTRAINT `fk_payment_period_request` FOREIGN KEY (`company_id`, `request_id`) REFERENCES `payment_period_request` (`company_id`, `id`) ON DELETE RESTRICT ON UPDATE CASCADE
...
-- Dump completed on 2025-10-04 21:28:06
